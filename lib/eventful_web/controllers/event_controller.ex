defmodule EventfulWeb.EventController do
  ...
  def new(conn, _params) do
    changeset = Resources.change_event(%Event{})
  ...
  def update(conn, %{"id" => id, "event" => event_params}) do
    ...
    case Resources.update_event(event, event_params) do
      {:ok, event} ->
        conn
  ...
  def delete(conn, %{"id" => id}) do
    event = Resources.get_event!(id)
    {:ok, _event} = Resources.delete_event(event)
